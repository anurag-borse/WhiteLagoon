...
namespace WhiteLagoon.Web.Controllers
{
    public class HomeController : Controller
    {
        ...
        public HomeController(IWebHostEnvironment webHostEnvironment, IVillaService villaService)
        {
        ...
        public IActionResult GeneratePPTExport(int id)
        {
            ...
            if (shape is not null)
            {
                shape.TextBody.Text = string.Format("INR {0}/night", villa.Price.ToString("c"));
            }
            ...
            if (shape is not null)
            {
                ...
                {
                    imageUrl = string.Format("{0}{1}", basePath, "/Image/placeholder.png");
                    imageData = System.IO.File.ReadAllBytes(imageUrl);
                }
